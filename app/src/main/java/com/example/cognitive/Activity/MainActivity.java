...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView()
    {
        ...
        bottom_bar_image_1.setImageResource(R.drawable.akito_1);
    ...
    public void setSelectStatus(int index)
    {
        switch (index)
        {
            case 0:
                ...
                bottom_bar_image_2.setImageResource(R.drawable.akito_2);
                bottom_bar_text_2.setTextColor(Color.parseColor("#000000"));

                bottom_bar_image_3.setImageResource(R.drawable.akito_3);
                bottom_bar_text_3.setTextColor(Color.parseColor("#000000"));

                bottom_bar_image_4.setImageResource(R.drawable.akito_4);
